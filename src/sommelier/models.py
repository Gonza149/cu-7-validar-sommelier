...
class Certificacion(models.Model):
    ...
    sommelier = models.ForeignKey('Sommelier', models.DO_NOTHING, db_column='sommelier')
...
class Sommelier(models.Model):
    ...
    sommeliervalidado_display.boolean = True
    sommeliervalidado_display.short_description = 'Sommelier Validado'
